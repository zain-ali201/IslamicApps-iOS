...
- (id)initWithFrame:(CGRect)frame andImages:(NSDictionary *)images withOptions:(PSAnalogClockViewOption)options
{
  ...
  if (self) {
    ...
    //_centreCapImageView  = [[UIImageView alloc] initWithFrame:imageViewFrame];
      ...
      [_clockFaceImageView setContentMode:UIViewContentModeScaleAspectFit];
      [_hourHandImageView setContentMode:UIViewContentModeScaleAspectFit];
      [_minuteHandImageView setContentMode:UIViewContentModeScaleAspectFit];
      [_secondHandImageView setContentMode:UIViewContentModeScaleAspectFit];
      [_centreCapImageView setContentMode:UIViewContentModeScaleAspectFit];
...
- (int)hours
{
  return (int)[[self.calendar components:NSHourCalendarUnit fromDate:self.now] hour];
}

- (int)minutes
{
  return (int)[[self.calendar components:NSMinuteCalendarUnit fromDate:self.now] minute];
}

- (int)seconds
{
  return (int)[[self.calendar components:NSSecondCalendarUnit fromDate:self.now] second];;
}

...
- (void)viewDidLoad {
    ...
    lblYear.text = [NSString stringWithFormat:@"©%@ Madina Traveller. All rights reserved",[dateFormatter stringFromDate:pickedYear]];
...
-(IBAction)sendMail:(UIButton*)button
{
    if([MFMailComposeViewController canSendMail])
    {
        ...
        [mailController setSubject:@"Madina Traveller Feedback"];
        [mailController setToRecipients:[NSArray arrayWithObjects:@"info@sprintsols.com",nil]];
        
        NSString *emailBody = [NSString stringWithFormat:@"<html><body><br/><br/><br/><p>Sent Via <a href='http://www.sprintsols.com'>Madina Traveller</a></p> </body></html>"];
